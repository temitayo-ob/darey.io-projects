# IMPROVING CLOUD INFRASTRUCTURE AUTOMATION PART 2

Improving cloud infrastructure automation brings increased efficiency, scalability, and reliability by leveraging advanced tools and practices to streamline the deployment, management, and orchestration of resources in cloud environment

## Network components (Internet and NAT gateway) with Tagging best practices

Continue Infrastructure Automation with Terraform, Let us continue from where we stopped in part 1, Based on our knowledge from the previous project, we can continue creating AWS resources!
...
## Automating Route Tables & Routes, IAM, Roles, & Instance profile
...
## Automate certificate management with AWS ACM
...
## Automating Load balancers (ALB, Targets groups & Listeners)
...
## SNS, Launch templates & Auto Scaling Groups
...
## Putting it all together in tfvars
...
![tplan2](./images/Tplan2.png)

below are some of the resources that were provisioned.
